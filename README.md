```
  _____ _   _ _____ ___  ____  ___ ___
 |_   _| | | | ____/ _ \|  _ \|_ _/ _ \
   | | | |_| |  _|| | | | |_) || | | | |
   | | |  _  | |__| |_| |  _ < | | |_| |
   |_| |_| |_|_____\___/|_| \_\___\__\_\
```

## Attribution

This repository builds on the work of two upstream projects, and we gratefully credit both:

- **Veda Labs / Se7en Seas** — original authors of the [boring-vault](https://github.com/Se7en-Seas/boring-vault) architecture, distributed as open source. We credit them for creating the BoringVault architecture and allowing its free distribution.
- **Paxos Labs** — for the Nucleus BoringVault work this repository is derived from.

This is an independent derivative maintained by Theoriq AI. It is not affiliated with, nor endorsed by, Veda Labs / Se7en Seas or Paxos Labs.
...
This project is licensed under the **GNU Affero General Public License v3.0** (AGPL-3.0). See [LICENSE](./LICENSE) for the full text and [NOTICE](./NOTICE) for third-party attributions.

The combined work is governed by AGPL-3.0 because it incorporates AGPL-3.0 dependencies (notably [solmate](https://github.com/transmissions11/solmate)). Other incorporated components are licensed under MIT, Apache-2.0, and GPL-2.0/3.0-or-later, all of which are compatible with AGPL-3.0; their notices are preserved in the source files and summarized in [NOTICE](./NOTICE). Source-available (BUSL-1.1) and unlicensed components have been excluded.
